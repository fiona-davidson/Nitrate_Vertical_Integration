...
for ix in np.arange(lx):
        for iy in np.arange(ly):
            ...
            ym = model[ind[0],704,108]#iy,ix].copy()
            yo = obs[ind[0],704,108]#iy,ix].copy()
...
outfile_obs = "/home/fid000/WORK7/ANALYSIS/model_evaluation/DATA/shallow_obs_2016month"+str(i)+".nc"
outfile_model = "/home/fid000/WORK7/ANALYSIS/model_evaluation/DATA/shallow_model_2016month"+str(i)+".nc"
